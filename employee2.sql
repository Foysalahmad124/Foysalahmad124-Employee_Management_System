...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 12, 2024 at 03:32 AM
...
CREATE TABLE `employee` (
  ...
  `tel_home` varchar(11) NOT NULL,
  `tel_mobile` varchar(11) NOT NULL,
...
INSERT INTO `employee` (`empId`, `nid`, `fname`, `lname`, `dob`, `address`, `city`, `gender`, `designation`, `department`, `tel_home`, `tel_mobile`, `date_of_joining`, `salType`, `salAmount`) VALUES
...
(11, '2353535', 'n n n n ', 'b  mn n n', '2020-02-03', 'dbfbnf', ' bfbf', 'Male', 'fbfg', 'gng', '2356987456', '0123654789', '2020-02-03', 'Monthly', 40000),
(12, '253563563', 'hgmghm ', 'bm hmh', '2020-02-03', 'b m ', 'v v v ', 'Male', 'n  ', ' bb b ', '2031645789', '0192364578', '2020-03-02', 'Monthly', 40000),
(13, '453535445', 'wetrudv', ' jm ', '1990-02-03', 'jkjkm', 'mkjkj', 'Male', ' vbv', 'v vb vb', '2134657894', '2314567894', '2020-03-25', 'Monthly', 50000),
(14, '21345678', ' nbnnmn', 'nnnnn', '2000-03-02', 'fffff', 'ffffff', 'Male', 'ggggg', 'gggggg', '2314657985', '2134567894', '2020-02-05', 'Monthly', 30000);
