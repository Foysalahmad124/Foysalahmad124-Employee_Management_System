...
//create and initialize varibales
    ...
    private void initComponents() {
        ...
        setTitle("Employee_Management_System | Login");
        ...
        lbl_background.setText("Employee_Management_Sstem");
...
//change titlebar icon    
    ...
    this.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("images/business.jpg")));
    }
