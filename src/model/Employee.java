...
public class Employee extends Person {
    ...
    public boolean insertEmployee() {
        ...
        String sql = "INSERT INTO employee (empId,nid,fname,lname,dob,address,city,tel_home,tel_mobile,designation,"
                + "department,date_of_joining,gender,salType,salAmount) VALUES ('" + empId + "','" + nid + "','" + fName + "','" + lName + "','" + dob + "',"
    ...
    public boolean updateEmployee() {
        ...
        String sql = "UPDATE employee set nid='" + nid + "',fname='" + fName + "',lname='" + lName + "',dob='" + dob + "',address='" + address + "',"
